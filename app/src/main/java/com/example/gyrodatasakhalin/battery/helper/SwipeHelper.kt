...
abstract class SwipeHelper(context: Context,
    ...
    abstract fun instantiateSwipeButton(viewHolder: RecyclerView.ViewHolder, buffer: MutableList<SwipeButton>)
    ...
    private fun drawButton(c: Canvas, itemView: View, buffer: MutableList<SwipeButton>, position: Int, translationX: Float) {
